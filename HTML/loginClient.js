        ...
        */
        ...
        .then(res => {
            ...
            if (users.response == 'OK') {         //<==Habilitar esto para dejar que el API REST verifique sin exponer la password
                ...
                console.log("changing to "+systemURL.listarTicket+"?id="+users.id+"&contacto="+users.contacto+"&nombre="+users.nombre+"&fecha_ultimo_ingreso="+users.fecha_ultimo_ingreso);
