...
/*-----------------------------------------------------------------------------------------------------------------
  ...
  REST API local (debe ejecutarse con node index.js) 
  UADER - IS1
  Caso de estudio MesaAyuda

  Dr. Pedro E. Colla 2023,2024
 *----------------------------------------------------------------------------------------------------------------*/
                ...
                if (Object.keys(data).length == 0) {
                    ...
                    if (password == paswd) {
                        if (activo == true) {
                            ...
                            res.status(200).send(JSON.stringify({response : "OK", "id" : id, "nombre" : nombre, "fecha_ultimo_ingreso": fecha_ultimo_ingreso}));    
                        } else {
...
/*----
listCliente
Lista todos los clientes en el data base
*/
app.get('/api/listCliente', (req,res) => {

    console.log("Processing listCliente");
    scanDbAll()
    .then(resultDb => {
      console.log(resultDb);
      data=resultDb;
      str="";
      //res.status(400).send({response: "OK",message : resultDb});
      data.forEach(function(result) {
        var arnValue = result.id;
        var arnContact= result.contacto;
        var arnPass=result.password;
        str=str+"id("+arnValue+") contacto("+arnContact+") password("+arnPass+")</br>";
